...
{
  m_cellAx = sqrt(m_Mm[0][0]*m_Mm[0][0]+m_Mm[0][1]*m_Mm[0][1]+m_Mm[0][2]*m_Mm[0][2]);
  m_cellBy = sqrt(m_Mm[1][0]*m_Mm[1][0]+m_Mm[1][1]*m_Mm[1][1]+m_Mm[1][2]*m_Mm[1][2]);
  m_cellCz = sqrt(m_Mm[2][0]*m_Mm[2][0]+m_Mm[2][1]*m_Mm[2][1]+m_Mm[2][2]*m_Mm[2][2]);
  m_cGamma = atan2(m_Mm[1][1],m_Mm[1][0]);
  m_cBeta = acos(m_Mm[2][0]/m_cellCz);
  m_cAlpha = acos(m_Mm[2][1]*sin(m_cGamma)/m_cellCz+cos(m_cBeta)*cos(m_cGamma));
